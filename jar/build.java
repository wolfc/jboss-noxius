...
public class build {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        compilerArgs.add("-cp");
        compilerArgs.add("../bootstrap/target/bootstrap-classes");
        ...
        //jar("cvfm", "target/hello.jar", "src/test/resources/MANIFEST.MF", "-C", "target/classes/", ".", "-C", "../bootstrap/target/bootstrap-classes", ".");
        jar("cvfm", "target/hello.jar", "src/test/resources/MANIFEST.MF", "-C", "target/classes/", ".");
        // $ jar uvf target/hello.jar -C ../bootstrap/target/bootstrap-classes/ .
        jar("uvf", "target/hello.jar", "-C", "../bootstrap/target/bootstrap-classes/", ".");
    }
}
